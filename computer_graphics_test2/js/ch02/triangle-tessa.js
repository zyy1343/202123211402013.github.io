...
function initTriangles_5() {
    points = []
	canvas = document.getElementById( "gl-canvas" );

    var n = parseInt(document.getElementById("layer_5").value);
    if (n) {
	...
	var vertices = [
        // radius * Math.cos((90 + angle) * Math.PI / 180.0), radius * Math.sin((90 + angle) * Math.PI / 180.0),  0,
        // radius * Math.cos((210 + angle) * Math.PI / 180.0), radius * Math.sin((210 + angle) * Math.PI / 180.0),  0,
        // radius * Math.cos((-30 + angle) * Math.PI / 180.0), radius * Math.sin((-30 + angle) * Math.PI / 180.0),  0
        radius * Math.cos((150 + angle) * Math.PI / 180.0), radius * Math.sin((150 + angle) * Math.PI / 180.0),  0,
        radius * Math.cos((270 + angle) * Math.PI / 180.0), radius * Math.sin((270 + angle) * Math.PI / 180.0),  0,
        radius * Math.cos((30 + angle) * Math.PI / 180.0), radius * Math.sin((30 + angle) * Math.PI / 180.0),  0
	];
